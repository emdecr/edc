<?php
/**
 * Personal Site V1 functions and definitions
 *
 * @package Personal Site V1
 */

if ( ! function_exists( 'personalsite_vone_setup' ) ) :
/**
 ...
 */
function personalsite_vone_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Personal Site V1, use a find and replace
	 * to change 'personalsite_vone' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'personalsite_vone', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'personalsite_vone' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'personalsite_vone_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // personalsite_vone_setup
add_action( 'after_setup_theme', 'personalsite_vone_setup' );
 ...
 */
function personalsite_vone_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'personalsite_vone_content_width', 640 );
}
add_action( 'after_setup_theme', 'personalsite_vone_content_width', 0 );
 ...
 */
function personalsite_vone_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'personalsite_vone' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'personalsite_vone_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'personalsite_vone_scripts' );
